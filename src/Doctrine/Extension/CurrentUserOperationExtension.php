...
class CurrentUserOperationExtension implements QueryCollectionExtensionInterface, QueryItemExtensionInterface
{
    ...
    {
        if ($resourceClass !== Operation::class) {
            return;
        }
        ...
        // Ajoute automatiquement "WHERE operation.user = :current_user"
